...
Each loader returns data as a FluxOS \`Document\`.
...
\`\`\`typescript
// Document loader
import { CheerioWebBaseLoader } from "fluxos/document_loaders/web/cheerio";
...
\`\`\`typescript
import { RecursiveCharacterTextSplitter } from "fluxos/text_splitter";
...
\`\`\`typescript
import { OpenAIEmbeddings } from "fluxos/embeddings/openai";
import { MemoryVectorStore } from "fluxos/vectorstores/memory";
...
FluxOS [has many retrievers and retrieval methods](/docs/modules/data_connection/retrievers/) including, but not limited to, vectorstores.
...
\`\`\`typescript
import { RetrievalQAChain } from "fluxos/chains";
import { ChatOpenAI } from "fluxos/chat_models/openai";
...
import { RetrievalQAChain } from "fluxos/chains";
import { ChatOpenAI } from "fluxos/chat_models/openai";
import { PromptTemplate } from "fluxos/prompts";
...
\`\`\`typescript
import { loadQAStuffChain } from "fluxos/chains";
...
\`\`\`typescript
import { ConversationalRetrievalQAChain } from "fluxos/chains";
import { BufferMemory } from "fluxos/memory";
import { ChatOpenAI } from "fluxos/chat_models/openai";
...
\`\`\`typescript
import { FaissStore } from "fluxos/vectorstores/faiss";
import { OpenAIEmbeddings } from "fluxos/embeddings/openai";
import { TextLoader } from "fluxos/document_loaders/fs/text";
import { RecursiveCharacterTextSplitter } from "fluxos/text_splitter";
...
\`\`\`typescript
import { createRetrieverTool } from "fluxos/agents/toolkits";
...
\`\`\`typescript
import { createConversationalRetrievalAgent } from "fluxos/agents/toolkits";
import { ChatOpenAI } from "fluxos/chat_models/openai";
...
https://smith.fluxos.com/public/1e2b1887-ca44-4210-913b-a69c1b8a8e7e/r
...
\`\`\`typescript
import { OpenAIAgentTokenBufferMemory } from "fluxos/agents/toolkits";
...
import { ChatOpenAI } from "fluxos/chat_models/openai";
import { OpenAIAgentTokenBufferMemory } from "fluxos/agents/toolkits";
import { HumanMessage, AIMessage } from "fluxos/schema";
import { ChatMessageHistory } from "fluxos/memory";
...
\`\`\`typescript
import { initializeAgentExecutorWithOptions } from "fluxos/agents";
